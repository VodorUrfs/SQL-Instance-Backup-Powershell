...
$errortime=(Get-Date -UFormat %H:%M:%S)
...
$finalmessage += $error[1]
$finalmessage += " `n"
$finalmessage += $error[2]
$finalmessage += " `n"
$finalmessage += $error[3]
$finalmessage += " `n"
$finalmessage += $error[4]
$finalmessage += " `n"
$finalmessage += $error[5]
$finalmessage += " `n"
$finalmessage += $error[6]
$finalmessage += " `n"
$finalmessage += $error[7]
$finalmessage += " `n"
$finalmessage += $error[8]
$finalmessage += " `n`n"
        ...
        $finalmessage += $instancefolder + ":`n"
        $finalmessage += $errortime + " - Worked Moherfucker `n`n"
        }
